...
import { flightMinutesDurationFormat, formatFlightDate, formatFlightTime, getPlaneType } from '@acme/utils';
...
const FlightInfomation = (props: Props) => {
    ...
    const { FlightInfoSelected, FlightInfo } = sessionData || {};
    ...
    // const adultPriceDeparture = flight.BaseAdult + flight.TaxAdult + flight.FeeAdult + flight.AirporFeetAdult;
                                ...
                                <div className='flex border border-grey-400 rounded py-1 px-2 ml-7'>
                                    ...
                                    <div className=''>
                                        ...
                                        <img
                                            ...
                                            src={FlightInfoSelected?.[0]?.AirlineImage}
                                        />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className=''>
                                    ...
                                    <div className='flex  border border-grey-400 rounded py-1 px-2 ml-7'>
                                        ...
                                        <div className=''>
                                            <img
                                                className='w-12 h-12 rounded object-cover'
                                                src={FlightInfoSelected?.[1]?.AirlineImage}
                                            />
                                        </div>
                                    </div>
                                </div>
