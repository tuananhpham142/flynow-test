...
const FlightSearch = (props: Props) => {
    ...
    return (
        <nav className='h-[144px] bg-white shadow-xs py-[24px] flex justify-center '>
            <div className='max-w-[1200px] flex flex-col gap-4 xl:px-0 px-4'>
                <div className='rounded w-full mb-2 flex items-center gap-2'>
