...
export declare type InputAttributes = Omit<
    ...
    'defaultValue' | 'value' | 'children' | 'size' | 'color'
>;
declare type NumberFormatProps<Props, BaseType = InputAttributes> = Props &
...
export declare type NumberFormatBase = {
...
export declare type InternalNumberFormatBase = Omit<
    NumberFormatBase,
    'format' | 'removeFormatting' | 'getCaretBoundary' | 'isValidInputCharacter'
>;
export declare type NumericFormatProps<BaseType = InputAttributes> = NumberFormatProps<
    ...
    BaseType
>;
export declare type PatternFormatProps<BaseType = InputAttributes> = NumberFormatProps<
    InternalNumberFormatBase & {
        format: string;
        mask?: string | string[];
